...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->boolean('active')->default(1)->after('role'); /* el 1 es un true */
    ...
    public function down()
    {
        Schema::table('users', function (Blueprint $table) {
            ...
            $table->dropColumn(['phone', 'birthdate', 'gender', 'address', 'photo', 'role', 'active' ]); /* solo elimino las nuevas columnas o propiedades */
        });
    }
};
